...
import { streamDeepResearchV2 } from '../utils/api';
import V2ReportView from '../components/v2/V2ReportView';
import V2StageTimeline from '../components/v2/V2StageTimeline';

/**
 * Deep Research v2 — agentic loop + multi-agent debate + Living Memo.
 *
 * Redesigned: shows a stage timeline during streaming, a collapsible activity
 * drawer for transparency, and the polished V2ReportView on completion.
 */
...
export default function DeepResearchV2Page() {
    ...
    // Build the report object from streamed state for V2ReportView
    ...
    return (
        <div className="fade-in">
            ...
            {/* ── V2 Report View (shown after completion) ── */}
            {assembledReport && (
                <V2ReportView report={assembledReport} mode="live" telemetry={telemetry} />
            )}
